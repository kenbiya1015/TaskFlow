...
const SAMPLE_TASKS = [
  ...
  // 古澤（運営 / 実務担当）
  t('sample-task-10', '定期購入リストの整理と顧客フォロー',           '健美屋','古澤',     'A', 1),
  t('sample-task-11', '健美屋オフィス向け提案資料の更新',             '健美屋','古澤',     'B', 3),
  t('sample-task-12', '在庫確認・追加発注の手配',                     '健美屋','古澤',     'B', 2),
  t('sample-task-13', '製造現場の動画撮影に立ち会う',                 'SNS',   '古澤',     'C', 6),

  // 有野（サポート / 施術担当）
  t('sample-task-20', '今週の整体予約者にリマインダー送信',           '整体',  '有野',     'A', 0),
  t('sample-task-21', '整体パッケージ顧客のリピート確認連絡',         '整体',  '有野',     'B', 2),
  t('sample-task-22', '施術スペースの清掃・備品チェック',             '整体',  '有野',     'D', 1),
]

// ───── アイデア ─────
const SAMPLE_IDEAS = [
  { id: 'sample-idea-01', text: '製造現場のショート動画シリーズ「健美屋の中の人」',                       author: '志村直紀', pinned: true,  createdAt: now },
  { id: 'sample-idea-02', text: '健美屋オフィスのトライアル1週間プラン（無料サンプル＋アンケート）',     author: '古澤',     pinned: false, createdAt: now - day },
  { id: 'sample-idea-03', text: '整体パッケージ会員に毎月健康食品を1袋プレゼント',                     author: '有野',     pinned: false, createdAt: now - day * 2 },
